...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('css/open-iconic-bootstrap.min.css'); ?>">
    ...
    <link rel="stylesheet" href=" <?php echo asset('css/bootstrap-datepicker.css'); ?> ">
...
<script src="<?php echo asset('js/jquery-migrate-3.0.1.min.js'); ?>"></script>
...
<script src="<?php echo asset('js/scrollax.min.js'); ?>"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="<?php echo asset('js/google-map.js'); ?>"></script>
<script src="<?php echo asset('js/main.js'); ?>"></script>

</body>
</html>
<?php /**PATH C:\wamp\www\laravel\resources\views/master.blade.php ENDPATH**/ ?>